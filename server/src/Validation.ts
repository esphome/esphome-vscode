...
export class Validation {
    ...
    private diagnosticCollection: Map<string, Diagnostic[]> = new Map<string, Diagnostic[]>();
            ...
            switch (msg.type) {
                case MESSAGE_READ_FILE: {
                    ...
                    try {
                        ...
                        this.addError(this.validating_uri!, Range.create(0, 0, 1, 0), `Could not open '${uri}': ${e}`);
                        this.connection.sendMessage({
                            type: 'file_response',
                            content: '',
                        });
