...
2. Use a **local installation of ESPHome**, if you can run esphome in your terminal, then you can use this option.
   ...
   If this does not work the fallback option is to have esphome in your global path, i.e. if you can run esphome in a regular terminal without loading a venv
...
Completion and hover help needs to pull schema from https://schema.esphome.io. The schemas are versioned so the extension will first connect to you Device Builder or local
